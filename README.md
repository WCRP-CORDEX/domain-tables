...
* `CORDEX-CMIP5_boundaries.csv`: Domain definitions in a regular latitude longitude CRS (`EPSG:4326`).
* `CORDEX-CMIP6_boundaries.csv`: Domain boundaries in a regular latitude longitude CRS (`EPSG:4326`).
