...
* `CORDEX-CMIP5_grids.csv`: Domain definitions in the rotated pole CRS in the CORDEX-CMIP5 era (`rotated_latitude_longitude`). 
* `CORDEX-CMIP6_grids.csv`: Domain definitions in the rotated pole CRS in the CORDEX-CMIP6 era (`rotated_latitude_longitude`).
* `CORDEX-CMIP5_boundaries.csv`: Domain boundaries in a regular latitude longitude CRS in the CORDEX-CMIP5 era (`EPSG:4326`).
* `CORDEX-CMIP6_boundaries.csv`: Domain boundaries in a regular latitude longitude CRS in the CORDEX-CMIP6 era (`EPSG:4326`).
